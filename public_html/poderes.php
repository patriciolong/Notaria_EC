...
<nav class="custom-navbar navbar navbar-expand-lg">
    ...
    <div class="container text-center mt-4">
        <h2 class="fs-2 fw-bold text-primary">Poderes</h2>
    </div>
    ...
    <div class="container form-section">
        <h3 class="mb-4">Registro de Poderes</h3>
        <form method="POST" action="" id="formPoderes">
            <?php
            include("conexionbd.php");
            // Assuming this controller handles the Poderes logic based on your previous patterns
            // Make sure "poderes_controller.php" exists and handles the form submission
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="mb-3">
                        <label for="tipo_poder" class="form-label">Tipo de Poder</label>
                        <select class="form-select" name="tipo_poder" id="tipo_poder">
                    ...
                    <div class="mb-3">
                        <label for="otorgante" class="form-label">Nombre del Otorgante</label>
                        <input type="text" class="form-control" name="otorgante" id="otorgante" />
                    </div>
                    <div class="mb-3">
                        <label for="ident_otorgante" class="form-label">Identificación del Otorgante</label>
                        <input type="text" class="form-control" name="ident_otorgante" id="ident_otorgante" />
                    </div>
                    <div class="mb-3">
                        <label for="apoderado" class="form-label">Nombre del Apoderado</label>
                        <input type="text" class="form-control" name="apoderado" id="apoderado" />
                    </div>
                    <div class="mb-3">
                        <label for="ident_apoderado" class="form-label">Identificación del Apoderado</label>
                        <input type="text" class="form-control" name="ident_apoderado" id="ident_apoderado" />
                    </div>
                    <div class="mb-3">
                        <label for="descripcion_poder" class="form-label">Descripción/Objeto del Poder</label>
                        <textarea class="form-control" name="descripcion_poder" id="descripcion_poder" rows="4"></textarea>
                    </div>
                    <div class="mb-3">
            ...
            <div class="button-container">
                <button type="submit" class="btn btn-submit-custom" name="btn_registro_poder">Registrar Poder</button>
            </div>
...
document.getElementById('formPoderes').addEventListener('submit', function (e) {
    ...
    formData.append("btn_registro_poder", "1"); // Ensure this matches the button name

    fetch('poderes_controller.php', { // Make sure this controller path is correct
        method: 'POST',
        body: formData
    })
    .then(res => {
...
document.getElementById('printRecordBtn').addEventListener('click', function() {
    ...
    if (recordId) {
        window.open('imprimir_poder.php?id=' + recordId, '_blank'); // Make sure this print page exists
    } else {
        Swal.fire({
            icon: 'warning',
            title: 'Atención',
        ...
        $.ajax(
            {
                data: parametros,
                dataType: 'json',
                url: 'poderes_controller.php', // Assuming this controller handles the search
                type: 'post',
